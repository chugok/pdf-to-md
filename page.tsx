      ...
      <div className="page">
        <div className="container">
          ...
          <div className="mode-selector">
            ...
            >
              <span className="mode-label">⚡ 자동</span>
              <span className="mode-desc">텍스트 없으면 OCR</span>
            </button>
            <button
              className={`mode-btn ${mode === 'text' ? 'active' : ''}`}
              onClick={() => setMode('text')}
            >
              <span className="mode-label">📝 텍스트</span>
              <span className="mode-desc">빠른 추출</span>
            </button>
            <button
              className={`mode-btn ${mode === 'ocr' ? 'active' : ''}`}
              onClick={() => setMode('ocr')}
            >
              <span className="mode-label">🔍 OCR</span>
              <span className="mode-desc">스캔/이미지 PDF</span>
            </button>
          </div>
          ...
          {loading && mode !== 'text' && (
            <div className="loading-info">
              {mode === 'ocr'
                ? '🔍 Claude Vision으로 OCR 처리 중... (30초~2분 소요)'
                : '⚡ 텍스트 추출 시도 중... 텍스트가 없으면 OCR로 전환됩니다'}
            </div>
          )}
            ...
            <div className="result">
              <div className="result-header">
                ...
                <div className="result-actions">
                  ...
                  <button className="btn btn-sm btn-success" onClick={downloadMd}>
                    💾 .md 다운로드
                  </button>
                </div>
              </div>
          ...
          <footer className="footer">
            Oxford Academy · PDF to Markdown Converter v2
          </footer>
        </div>
      </div>
    </>
